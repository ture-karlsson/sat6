...
def one_liners():
    ...
    print 'ORGANIZATION   LOCATION   NAME   ID   ACTIVATION KEYS   LIFECYCLE ENVIRONMENT   CONTENT VIEW   DISTRIBUTION   VIRTUAL/PHYSICAL KATELLO-AGENT INSTALLED   LAST REPORT   ENTITLEMENT STATUS   ERRATA COUNT: TOTAL(SECURITY, BUGFIX, ENHANCEMENT)   ARCHITECTURE   CPU(S)   TOTAL MEMORY   IPv4 ADDRESS'
